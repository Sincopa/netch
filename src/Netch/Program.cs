...
public static class Program
{
    ...
    private static readonly LogBufferSink WebLogSink = new();
...
#pragma warning disable VSTHRD002
    ...
    public static void Main(string[] args)
    {
        ...
        WinFormsApplication.ThreadException += Application_OnException;
        WinFormsApplication.ApplicationExit += Application_OnExit;

        WinFormsApplication.SetHighDpiMode(HighDpiMode.PerMonitorV2);
        WinFormsApplication.EnableVisualStyles();
        WinFormsApplication.SetCompatibleTextRenderingDefault(false);
        WinFormsApplication.Run(new DesktopHostForm(WebLogSink));
    }
