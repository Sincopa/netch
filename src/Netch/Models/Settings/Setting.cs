...
{
    public string? LocalRoutingModePath { get; set; }
    public int RoutingPreferencesVersion { get; set; }
    ...
    /// <summary>
    ///     Versioned, credential-free fingerprints of favorite server endpoints.
    /// </summary>
    ...
    public string LatencyTestMethod { get; set; } = "http";

    public string LatencyTestUrl { get; set; } = "https://www.google.com/generate_204";
